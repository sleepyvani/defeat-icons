...
export const ChevronMaximizeDiagonal = (props, context) => h(Icon, { ...props, iconNode }, context ? context.slots : undefined);
ChevronMaximizeDiagonal.props = ['size', 'width', 'height'];
