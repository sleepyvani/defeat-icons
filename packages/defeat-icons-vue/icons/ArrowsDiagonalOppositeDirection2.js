...
export const ArrowsDiagonalOppositeDirection2 = (props, context) => h(Icon, { ...props, iconNode }, context ? context.slots : undefined);
ArrowsDiagonalOppositeDirection2.props = ['size', 'width', 'height'];
