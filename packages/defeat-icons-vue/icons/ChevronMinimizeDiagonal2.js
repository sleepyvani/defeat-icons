...
export const ChevronMinimizeDiagonal2 = (props, context) => h(Icon, { ...props, iconNode }, context ? context.slots : undefined);
ChevronMinimizeDiagonal2.props = ['size', 'width', 'height'];
